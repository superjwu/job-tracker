...
export default function ApplicationDetail({ params }) {
  ...
  async function updateApp(updates) {
    setSaving(true);
  ...
  async function handleChecklistChange(key, value) {
    await updateApp({ checklist: { [key]: value } });
  }

  async function handleNotesBlur() {
    if (notes !== app.notes) {
      await updateApp({ notes });
    }
  }
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-3">Company Research Notes</h2>
            <textarea
              value={notes}
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-3">
              ...
              <span className="text-xs text-gray-500">
                {checklistDone}/{checklistKeys.length}
              </span>
            </div>
